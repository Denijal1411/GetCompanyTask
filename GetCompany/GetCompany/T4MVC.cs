...
{
    public static GetCompany.Controllers.HomeController Home = new GetCompany.Controllers.T4MVC_HomeController();
    public static GetCompany.Controllers.ProjectController Project = new GetCompany.Controllers.T4MVC_ProjectController();
    public static GetCompany.Controllers.TaskController Task = new GetCompany.Controllers.T4MVC_TaskController();
    public static GetCompany.Controllers.UserController User = new GetCompany.Controllers.T4MVC_UserController();
    ...
    public static partial class Bundles
    {
        ...
        public static partial class Content 
        {
            public static class Assets
            {
                ...
                public static readonly string Home_css = T4MVCHelpers.ProcessAssetPath("~/Content/Home.css");
